...
return: sorted list
*/
cityList* sortCities(char *countryName, int dataType){
...
void print_cities(char *countryName){
    cityList *sortedCity = sortCities(countryName, 0); //sort by 0 = pop
...
void print_cities2(char *countryName, int dataType, int order, char *startCity){
    cityList *sortedCity = sortCities(countryName, dataType); 
